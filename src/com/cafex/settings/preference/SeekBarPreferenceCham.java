package com.cafex.settings.preference;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String SYBERIASETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, SYBERIASETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, SYBERIASETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(SYBERIASETTINGSNS, "interval");
            if(newInterval != null)
